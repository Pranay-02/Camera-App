//constraints - defines the capabilities of getUsermedia function , can include audio and video
...
// a browser's predefined object - navigator
// mediaDevices - child of navigator , also an object
// getUserMedia - it is a function that returns a promise
// mediaStream - an object that contains input of the video and audio from browser
// srcObject - specifies the mediaStream url to the video element
...
navigator.mediaDevices.getUserMedia(constraints).then(function (mediaStream) {
  ...
  mediaRecorder.onstop = function () {
      // combine the chunks into single raw data
...
function capture(filter) {
  ...
  addMediaToGallery(c.toDataURL(), "img");   // data comes as a single chunk and gives a url for that
}
